...
#'
#' @description
#' Hierarchical Bayesian Modeling of the Choice under Risk and Ambiguity Task with the following parameters: "alpha" (risk attitude), "beta" (ambiguity attitude), and "gamma" (inverse temperature).
#'
#' Contributor: \href{https://ccs-lab.github.io/team/jaeyeong-yang/}{Jaeyeong Yang} and \href{https://ccs-lab.github.io/team/harhim-park/}{Harhim Park}
#'
#' \strong{MODEL:}
#' Linear Subjective Value Model (Levy et al., 2010, J Neurophysiol)
#'
...
#' \describe{
#'  \item{\code{model}}{Character string with the name of the model (\code{"cra_linear"}).}
...
#' "subjID", "P", "A", "V_var", "V_fix" and "choice". It is not necessary for the columns to be in this
...
#'
#' @references
#' Levy, I., Snell, J., Nelson, A. J., Rustichini, A., & Glimcher, P. W. (2010). Neural representation of subjective value under risk and ambiguity.
...
cra_linear <- function(data           = "choose",
                       niter          = 2000,
                       nwarmup        = 1000,
                       nchain         = 1,
                       ncore          = 1,
  ...
  modelPath <- system.file("stan", "cra_linear.stan", package="hBayesDM")
