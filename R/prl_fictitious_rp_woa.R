...
#' output <- prl_fictitious_rp_woa("example", niter=2000, nwarmup=1000, nchain=3, ncore=3)
#'
...
prl_fictitious_rp_woa <- function(data           = "choice",
                                  niter          = 3000,
                                  nwarmup        = 1000,
                                  nchain         = 1,
                                  ncore          = 1,
  ...
  modelPath <- system.file("stan", "prl_fictitious_rp_woa.stan", package="hBayesDM")
  ...
  modelName <- "prl_fictitious_rp_woa"
